...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name') }} {{ env('APP_VERSION') }}</title>
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div>
                    <p style="color:white; font-size: 200%">{{ config('app.name') }} {{ env('APP_VERSION') }}</p>
                </div>
                ...
                <div style="margin-top: -3%; margin-bottom: -1.5%">
                    ...
                    <p style="color:white; font-size: 90%; margin-top: -1%">4. Admin Panel {{ env('TEMPLATE_ADMIN_VERSION') }}</p>
                </div>
